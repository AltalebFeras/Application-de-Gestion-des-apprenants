            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div id="contentPromotion">
                    ...
                    <div class="d-flex justify-content-between my-3 mx-2">
                        ...
                        <button id="ajouterPromotion" class="btn btn-success">Ajouter apprenant</button>

                        <h3 class="m-3">Promotion <?php echo $promo->getNom(); ?></h3>

                        <p class="m-3">informations générales de la <?php echo $promo->getNom(); ?></p>
